...
two = usalma(2)
print(two(3))
# === İç Fonksiyon ile Yetki Kontrolü ===
print("?"*30)
...
# === Decorator Kullanımı (Fonksiyonun Çalışma Süresi) ===
print("?"*30)
import math
import time
...
# === Fonksiyondan Fonksiyon Döndürme (Toplama/Çarpma) ===
print("?"*30)
