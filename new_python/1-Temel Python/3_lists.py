...
# 1- Liste Oluşturma ve Temel İşlemler
print("1- Liste oluşturma ve temel işlemler")
list1 = ['one','two','there']
list2 = ['four','five','six']
numbers1 = list1 + list2
print("Birleştirilmiş liste:", numbers1)
print("Uzunluk:", len(numbers1))
print("İlk eleman:", numbers1[0])
print("Üçüncü eleman:", numbers1[2])
print("\n" + 20 * '-' + "\n")

# 2- String'den Listeye Dönüştürme
print("2- String'den listeye dönüştürme")
message2 = 'Hello There. My name is Sadık Turan'.split()
print("Oluşan liste:", message2)
print("İlk kelime:", message2[0])
print("\n" + 20 * '-' + "\n")

# 3- Farklı Tipte Elemanlar
print("3- Farklı tipte elemanlar")
my_list1 = [1,2,3]
my_list2 = ['bir',2, True, 5.6]
print(my_list1)
print(my_list2)
...
# =====================================================
# 5- Listelerle Uygulama ve Sık Kullanılan İşlemler
print("5- Listelerle uygulama ve sık kullanılan işlemler")
...
# 6- Liste Metodları ve Fonksiyonları
print("6- Liste metodları ve fonksiyonları")
...
# 7- Liste Uygulama Soruları
print("7- Liste uygulama soruları")
