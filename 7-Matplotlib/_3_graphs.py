...
# s markerın alanını piksel olarak belirtir
...
# Histogram grafiği frekans oluşturmak için kullanılır
...
plt.xticks(yas_gruplari)
# x eksenindeki değerleri yaş_gruplarına göre ayarladık
